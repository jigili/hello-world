...
def load_dataset(path=None, update_date=None, modules=None):
    ...
    # indicator_vars = {'bsl_1':4,'bsl_2':5,'bsl_3':6,'holiday':7,'weekday_0':8,'weekday_1':9,'weekday_2':10,'weekday_3':11,'weekday_4':12,'weekday_5':13,
    #                   'weekday_6':14,'hour_0': 15, 'hour_1':16, 'hour_2':17, 'hour_3':18, 'hour_4':19, 'hour_5':20,
    #                   'hour_6':21, 'hour_7':22, 'hour_8':23,'hour_9':24, 'hour_10':25, 'hour_11':26, 'hour_12':27,
    #                   'hour_13':28, 'hour_14':29, 'hour_15':30, 'hour_16':31,'hour_17':32, 'hour_18':33, 'hour_19':34,
    #                   'hour_20':35, 'hour_21':36, 'hour_22':37, 'hour_23':38,'month_1':39, 'month_2':40, 'month_3':41,
    #                   'month_4':42, 'month_5':43, 'month_6':44, 'month_7':45, 'month_8':46,'month_9':47, 'month_10':48,
    #                   'month_11':49, 'month_12':50}
    indicator_vars = { 'holiday': 4, 'weekday_0': 5, 'weekday_1': 6, 'weekday_2': 7,'weekday_3': 8, 'weekday_4': 9, 'weekday_5': 10,
                      'weekday_6': 11,'month_1': 12, 'month_2': 13,'month_3': 14,'month_4': 15, 'month_5': 16, 'month_6': 17, 'month_7': 18, 'month_8': 19, 'month_9': 20,
                      'month_10': 21,'month_11': 22, 'month_12': 23}
    indicator_vars={}
    ...
    if update_date:
        ...
        # last_actual_obs = df['demand_load'].last_valid_index()
        last_obs = df.index[-1]
...
def update_dataset(df=None, to_date=None):
    ...
    # starting = starting.tz_convert('America/New_York')
    ...
    if starting < now:
        ...
        df_a.index = df_a.index.tz_localize('America/New_York')
    ...
    # df_f.index = df_f.index.tz_localize('America/New_York')
